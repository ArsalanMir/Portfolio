    ...
    return(
        <div className="bg-black text-white py-20 " id="about">
            <div className="container mx-auto px-8 md:px-16 lg:px-24">
                <h2 className="text-4xl font-bold text-center items-center mb-6">About Me</h2>
                <div className="flex flex-col md:flex-row items-center md: space-x-12">
                    <img src={myImg} alt="" className=" w-72 h-80 rounded object-cover mb-8 md:mb-0" />
                    <div className="flex-1 ">
                        <p className=" text-lg mb-8">
                        I am a passionate web developer with a focus on building modern and responsive
                        web application.I love to learn new skills, i strive t0 create seamless and 
                    ...
                    <div className="mt-12 flex justify-between text-center">
                        ...
                        <div>
                            <h3 className="text-2xl  font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500"> Fresher </h3>
